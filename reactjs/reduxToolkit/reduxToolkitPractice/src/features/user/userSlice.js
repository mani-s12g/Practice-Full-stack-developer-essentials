...
export const fetchUserById = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      ...
      // Use rejectWithValue to return a value that becomes the action.payload in the 'rejected' case
...
const userSlice = createSlice({
  ...
  // createAsyncThunk automatically generates 3 lifecycle actions i.e., 
  // 1. pending, 2. fulfilled, 3. rejected - these represent different stages of async operations
  // Simplified reducer logic - can easily handle these generated actions in reducers using extraReducers 
  // within createSlice
