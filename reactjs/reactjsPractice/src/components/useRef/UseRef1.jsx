...
// In React 18 development mode (with StrictMode enabled in index.js), React intentionally mounts, unmounts, and re-mounts components twice to help you detect unexpected side effects.
